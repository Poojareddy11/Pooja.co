        ...
        <div className="max-w-frame mx-auto">
            ...
            <div className="flex flex-col lg:col-span-3 lg:max-w-[248px]">
              <h1
                className={cn([
                  ...
                  "text-[28px] lg:text-[32px] mb-6 text-pink-600 font-bold",
                ])}
              >
                POOJA.CO
              </h1>
              <p className="text-black/60 text-sm mb-9">
                Clothing that complements your style — and makes you proud to wear it. For women and men alike.
              </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center mb-2">
            <p className="text-sm text-center sm:text-left text-black/60 mb-4 sm:mb-0 sm:mr-1">
              Pooja.co © Made by{" "}
              <Link
                href="https://github.com/Poojareddy11"
              ...
              Designed by{" "}
              <Link
                href="https://poojareddy11.github.io/Portfolio/"
                className="text-black font-medium"
              >
                Pooja
              </Link>
