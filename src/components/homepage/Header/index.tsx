        ...
        <section className="max-w-frame px-4">
          <motion.h2
            ...
            className={cn([
              ...
              "text-4xl lg:text-[64px] lg:leading-[64px] mb-5 lg:mb-8 text-purple-600 font-bold",
            ])}
          >
          ...
          >
            Discover a world of style with our handpicked fashion pieces, made to highlight your personality and taste
          </motion.p>
          <motion.div
            initial={{ y: "100px", opacity: 0 }}
            whileInView={{ y: "0", opacity: 1 }}
          ...
          >
            ...
            <div className="flex flex-col w-full text-center sm:w-auto sm:text-left mt-3 sm:mt-0 sm:ml-6 md:ml-0">
              <span className="font-bold text-2xl md:text-xl lg:text-3xl xl:text-[40px] xl:mb-2">
                <AnimatedCounter from={0} to={8000} />+
              </span>
              <span className="text-xs xl:text-base text-black/60 text-nowrap">
                Happy Customers
              </span>
